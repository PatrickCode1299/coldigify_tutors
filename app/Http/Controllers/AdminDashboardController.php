...
class AdminDashboardController extends Controller
{
   ...
   public function examine(){
      ...
      if(isset($fetch_tutor_questions)){
         return view('auth.exam_set')->with(['tutor_course'=>$fetch_all_tutor_course, 'tutor_question'=>$fetch_tutor_questions]);
      }else{
         return view('auth.exam_set')->with(['tutor_course'=>$fetch_all_tutor_course]);
      }

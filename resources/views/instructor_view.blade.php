...
<div class="container">
	<div class="row" style="flex-direction: row-reverse; align-items: center; justify-content: center;">
		<div class="col-sm-4" style="margin-left:auto; margin-bottom: 20px;">
			 @if(empty($tutor_info->avatar))
        <img src="/profile_avatar/default.jpg"
              height="200px" width="200px" style="border-radius:50%;" class="float-left img-circle  img-circle" alt="Avatar" loading="lazy" />
        @else
        <img src="/profile_avatar/{{$tutor_info->avatar}}"
              height="200px" width="200px" style="border-radius:50%;" class="float-left img-circle  img-rounded" alt="Avatar" loading="lazy" />
        @endif
		</div>
		<div class="col-sm-4">
	...
	<div class="container-fluid">
        ...
        ?>
 			...
 			<img loading="lazy"   class="img-rounded img-thumbnail" src="/storage/preview/{{$courses->preview}}">

...
<div class="container">
	<div class="jumbotron" style="margin-bottom: 20px; height: ; position: relative;">
		<img  src="/storage/preview/ad.jpg" style="border-radius: 10px;width:100%; object-fit: cover; height:300px;">
	...
	<div class="row">
        ...
        ?>
			<a href="{{route('preview.show',$parameter)}}"><div class="card p-2">
				<img loading="lazy"  class="buy-showcase img-rounded img-thumbnail" src="/storage/preview/{{$users_category->preview}}">
	...
	@endif
	<div class="container">
		<h2 style="margin-bottom:30px; font-weight:bold; margin-top: 20px;">Our Users are Learning</h2>
		...
		<div class="row" style="margin-bottom:20px;">
			<h4>{{$our_category->category}}</h4>
		<div class="col-sm-4" style="margin-left:10px;">
			<a href="{{route('preview.show',$parameter)}}"><div class="card p-2">
				<img loading="lazy"  class="buy-showcase img-rounded img-thumbnail" src="/storage/preview/{{$our_category->preview}}">
	...
	<div class="container-fluid">
		<h3  style="font-weight:bolder; margin-top: 20px; color:black;">Courses to get you started</h3>

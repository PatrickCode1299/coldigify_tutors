  ...
  <div class="flex-div-edu-info shadow-lg">
    ...
    <form method="POST" action="{{route('upload.pic')}}" enctype="multipart/form-data" class="form-inline">
      ...
      <div class="form-group">
          ...
          <textarea name="about" style="resize: none; height: 400px;" placeholder="Write something lenghty about yourself e.g I am Cornelius a business developer at coldigify, i have worked as a BDM for over a decade, my area of specialization involves busines management......" class="form-control" required></textarea>
